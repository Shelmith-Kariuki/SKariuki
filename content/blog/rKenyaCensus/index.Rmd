...
I have always wanted to learn package development through a real life project. I am glad that I can now use the _usethis::use_data(xxx, overwrite = T)_ command, and I know what _"r cmd-check"_ is (thanks to [Jenny Bryan](https://twitter.com/JennyBryan)). I also needed to work on a project that I could showcase, during my next interview, incase they ask how I spent my time during the Covid19 pandemic (yes, I am job hunting `r rep(emo::ji("sad"),4)`).
...
One of the major lessons that I learnt from the process is that data cleaning is an important skill. A huge thanks to my friends at the [R4DS community](https://twitter.com/R4DScommunity), especially  [Scott Came](https://twitter.com/scottcame), who came through when I needed help   with a certain regular expressions problem that I was facing. 

```{r, echo=FALSE}
knitr::include_graphics("img/scottcame.png")
```

I hope that I will become better at handling regular expressions, soon (`r rep(emo::ji("cry"),5)`).
