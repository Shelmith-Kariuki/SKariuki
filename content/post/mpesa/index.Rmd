...
[M-PESA](https://www.safaricom.co.ke/personal/m-pesa), operated by [Safaricom](https://www.safaricom.co.ke/) is a mobile money transfer service in Kenya. It is one of the best online payment options. One can use M-PESA to buy airtime, send or receive cash on their phones and pay goods and/or services using merchant paybill numbers or till numbers. The following is an example of an M-Pesa text message that one would receive if they paid for goods or services via a till number. 
